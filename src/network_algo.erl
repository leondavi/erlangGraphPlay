...
generate_vertices_layer_z(Graph,{X,Y,Zi})-> generate_vertices_layer_y(Graph,{X,Y},Zi),
                                            generate_vertices_layer_z(Graph,{X,Y,Zi-1}).
...
remove_vertices_by_percentage(Graph,MaxN,Percentage)-> NumToRemove = trunc(length(digraph:vertices(Graph))*(Percentage/100)),
